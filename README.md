...
- [Cross-Examine](https://github.com/stefbuilds/cross-examine) - Finds behavioral regressions in AI-generated Python pull requests with base/head execution and exact-command receipts.
